...
public class ObjectSpace
{
	 ...
	 * <p>
	 * If {@link RemoteObject#setNonBlocking(boolean) non-blocking} is false (the
	 * default), then methods that return a value must not be called from the
	 * update thread for the connection. An exception will be thrown if this
