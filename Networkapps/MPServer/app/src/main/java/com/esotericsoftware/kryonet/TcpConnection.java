	...
	public Object readObject(Connection connection) throws IOException
	{
		...
		if (currentObjectLength == 0)
		{
			...
			if (currentObjectLength > readBuffer.capacity())
				throw new KryoNetException("Unable to read object larger than read buffer: obj size:" + currentObjectLength + ", max capacity: " + readBuffer.capacity());
			else
				System.out.println("TCPCOnnection: recieved object of size: " + currentObjectLength + ", max capacity: " + readBuffer.capacity());
		}
		...
		System.out.println("TCPCOnnection: Object is: "+object);
		return object;
	}
